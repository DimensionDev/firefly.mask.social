...
./scripts/setup-packages.sh ./src/maskbook/node_modules ./node_modules "react-use@17.5.1"
...
./scripts/setup-packages.sh ./src/maskbook/node_modules ./node_modules "async-call-rpc@6.4.2"
