...
export function AccountSetting({ source, profile }: AccountSettingProps) {
    ...
    return (
        <Tippy
            ...
            content={
                <div className="flex w-[286px] flex-col rounded-2xl bg-primaryBottom px-5 shadow-[0px_8px_20px_0px_rgba(0,0,0,0.04)] dark:bg-bg dark:shadow-[0px_8px_20px_0px_rgba(255,255,255,0.04)]">
