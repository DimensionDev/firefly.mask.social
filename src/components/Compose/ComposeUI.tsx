...
export const ComposeUI = memo(function ComposeUI() {
    ...
    return (
        <>
            <div className="flex max-h-[300px] min-h-[100px] flex-grow flex-col overflow-auto px-4 pb-4 md:max-h-[500px] md:min-h-[338px]">
                <div
                    ref={contentRef}
                    className="flex flex-1 flex-grow flex-col overflow-auto rounded-lg border border-secondaryLine bg-bg px-4 py-[14px]"
                >
