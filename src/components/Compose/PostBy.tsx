...
export function PostBy(props: PostByProps) {
    ...
    return (
        ...
        >
            <Popover.Panel className="no-scrollbar absolute bottom-full right-0 z-10 flex max-h-[275px] w-[280px] -translate-y-3 flex-col gap-2 overflow-y-auto rounded-lg bg-bgModal p-3 text-[15px] shadow-popover dark:border dark:border-line dark:shadow-none md:max-h-[370px]">
