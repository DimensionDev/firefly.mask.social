...
export function ChannelSearchPanel({ onSelected }: ChannelSearchPanelProps) {
    ...
    return (
        ...
        >
            <Popover.Panel className="absolute bottom-full right-0 z-10 flex w-[350px] -translate-y-3 flex-col gap-2 rounded-lg bg-lightBottom py-3 text-medium shadow-popover dark:border dark:border-line dark:bg-darkBottom dark:shadow-none">
                {InputBox}
                {ListBox}
            </Popover.Panel>
        </Transition>
