...
function getMentionRegexString(): string {
    const { alpha, alphanumeric, hashChars } = getMentionRegexStringChars();
...
const REGEX = new RegExp(getMentionRegexString(), 'i');
...
export function MentionsPlugin(): JSX.Element | null {
    ...
    useLexicalTextEntity<MentionNode>(getHashtagMatch, MentionNode, createMentionNode);
