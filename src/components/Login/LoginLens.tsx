...
export function LoginLens({ profiles, currentAccount }: LoginLensProps) {
    ...
    return (
        <div
            className="flex flex-col md:overflow-auto rounded-[12px] md:max-h-[535px] md:w-[600px] pb-[50px] md:pb-[80px]"
            style={{ boxShadow: '0px 4px 30px 0px rgba(0, 0, 0, 0.10)' }}
        >
            <div className="md:no-scrollbar flex w-full flex-col gap-4 md:overflow-auto md:min-h-[300px] md:p-4">
                {profiles.length ? (
                    <>
