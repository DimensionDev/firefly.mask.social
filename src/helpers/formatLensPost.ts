...
export function formatLensPost(result: AnyPublicationFragment): Post {
    ...
    if (result.__typename === 'Mirror') {
        ...
        return {
            ...
            hasMirrored: result.mirrorOn.operations.hasMirrored || result.mirrorOn.operations.hasQuoted,
    ...
    if (result.__typename === 'Quote') {
        return {
            ...
            hasMirrored: result.operations.hasMirrored || result.operations.hasQuoted,
