...
export function SettingsList() {
    ...
    return (
        <div
            className={`
          flex min-h-full min-w-full flex-col border-r border-line p-6
        ...
        >
            <div
                className={`
              hidden pb-6 text-[20px] font-bold leading-[24px] text-lightMain
            ...
            {[
                ...
                return link === '/connected' && !isLoggedIn ? null : (
                    <Link
                        className={`
                          mb-6 flex items-center justify-between border-b border-line pb-1
                          text-[18px] leading-[24px] text-main
