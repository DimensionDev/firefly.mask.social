...
export function LinkCard({ logo: Icon, link, content }: LinkCardProps) {
    return (
        <Link
            href={link}
            className={`
              inline-flex h-[48px] w-full items-center justify-start gap-2 rounded-lg bg-white px-3
              py-2
        ...
        >
            ...
            <div
                className={`
              inline-flex shrink grow basis-0 flex-col items-start justify-center gap-1
            `}
            >
