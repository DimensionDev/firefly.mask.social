...
export default function More() {
  return <div className="flex flex-col w-full p-[24px] items-center gap-[12px]">
    ...
    <div className="w-full h-[48px] px-[12px] py-[8px] bg-white rounded-lg  justify-start items-center gap-[8px] inline-flex" style={{ boxShadow: '0px 0px 20px 0px rgba(0, 0, 0, 0.05)', backdropFilter: 'blur(8px)' }} >
