...
import {
    ...
    SecurityType,
    type TokenSecurityType,
} from '@/providers/types/Security.js';

function isUnset(name: keyof TokenSecurityType) {
    return (info: TokenSecurityType) => info[name] === undefined;
}
...
export const SecurityMessages: SecurityMessage[] = [
    // open source
    {
        ...
        condition: (info: TokenSecurityType) => info.is_open_source === '1',
    ...
    },
    {
        ...
        condition: (info: TokenSecurityType) => info.is_open_source === '0',
    ...
    // proxy
    {
        ...
        condition: (info: TokenSecurityType) => info.is_proxy === '1',
    ...
    },
    {
        type: SecurityType.Contract,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.is_proxy === '0',
        title: () => t`No proxy`,
        message: () =>
    ...
    // mint
    {
        type: SecurityType.Contract,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.is_mintable === '0',
    ...
    },
    {
        type: SecurityType.Contract,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) => info.is_mintable === '1',
    ...
    // owner change balance
    {
        type: SecurityType.Contract,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.owner_change_balance === '0',
    ...
    },
    {
        type: SecurityType.Contract,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) => info.owner_change_balance === '1',
    ...
    // can take back ownership
    {
        type: SecurityType.Contract,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.can_take_back_ownership === '0',
    ...
    },
    {
        type: SecurityType.Contract,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) => info.can_take_back_ownership === '1',
    ...
    // buy tax
    {
        ...
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => percentageToNumber(info.buy_tax) < 10,
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) =>
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.High,
        condition: (info: TokenSecurityType) => percentageToNumber(info.buy_tax) >= 50,
        title: (info) => t`Buy Tax: ${percentageToNumber(info.buy_tax)}%`,
        message: () =>
            t`Above 10% may be considered a high tax rate. More than 50% tax rate means may not be tradable.`,
        shouldHide: isUnset('buy_tax'),
    ...
    // sell tax
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => percentageToNumber(info.sell_tax) < 10,
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.High,
        condition: (info: TokenSecurityType) => percentageToNumber(info.sell_tax) >= 50,
        title: (info) => t`Sell Tax: ${percentageToNumber(info.sell_tax)}%`,
        message: () =>
            t`Above 10% may be considered a high tax rate. More than 50% tax rate means may not be tradable.`,
        shouldHide: isUnset('sell_tax'),
    ...
    // honeypot
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.is_honeypot === '0',
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.High,
        condition: (info: TokenSecurityType) => info.is_honeypot === '1',
    ...
    // transfer_pausable
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.transfer_pausable === '0',
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) => info.transfer_pausable === '1',
    ...
    // anti whale
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.is_anti_whale === '0',
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) => info.is_anti_whale === '1',
    ...
    // slippage modifiable
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.slippage_modifiable === '0',
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) => info.slippage_modifiable === '1',
    ...
    // black list
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.is_blacklisted === '0',
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) => info.is_blacklisted === '1',
    ...
    // white list
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.is_whitelisted === '0',
    ...
    },
    {
        type: SecurityType.Transaction,
        level: SecurityMessageLevel.Medium,
        condition: (info: TokenSecurityType) => info.is_whitelisted === '1',
    ...
    // true token
    {
        ...
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.is_true_token === '1',
        title: () => t`True Token`,
        message: () =>
    ...
    },
    {
        type: SecurityType.Info,
        level: SecurityMessageLevel.High,
        condition: (info: TokenSecurityType) => info.is_true_token === '0',
        title: () => t`Fake Token`,
        message: () =>
    ...
    // Airdrop scam
    {
        type: SecurityType.Info,
        level: SecurityMessageLevel.Safe,
        condition: (info: TokenSecurityType) => info.is_airdrop_scam === '0',
    ...
    },
    {
        type: SecurityType.Info,
        level: SecurityMessageLevel.High,
        condition: (info: TokenSecurityType) => info.is_airdrop_scam === '1',
