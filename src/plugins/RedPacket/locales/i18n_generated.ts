...
export function useRedPacketTrans(): {
     ...
     */
    nft_max_shares(options: { readonly amount: string }): string;
    /**
     * `The NFT lucky drop supports up to {{amount, number}} NFTs selected for one time.`
     */
    nft_max_shares_tip(options: { readonly amount: string | number | bigint }): string;
    /**
     ...
     */
    data_broken(options: { readonly duration: string }): string;
    /**
     * `Refund`
     */
    refund(): string;
     ...
     * `Split Mode: {{mode}}`
     */
    history_split_mode(options: { readonly mode: string }): string;
    /**
     * `Attached Message`
     */
     ...
     * `ALL ({{total}} NFT)`
     */
    nft_select_all_option(options: { readonly total: string }): string;
    /**
     ...
     */
    erc721_gas_cap(options: { readonly symbol: string }): string;
    /**
     * `Collectibles`
     */
     ...
     * `Claimed {{- amount}}`
     */
    claimed(options: { readonly amount: string }): string;
    /**
     * `Received`
     */
    received(): string;
     ...
     * `Send {{count}} NFT`
     */
    send_symbol_one(options: { readonly count: (string | number | bigint) & (string | number | bigint) }): string;
    /**
     * `Send {{count}} NFTs`
     */
    send_symbol_other(options: { readonly count: string | number | bigint }): string;
    /**
     * `Insufficient Balance`
     */
     ...
     */
    insufficient_token_balance(options: { readonly symbol: string }): string;
    /**
     * `Back`
     */
    back(): string;
     ...
     */
    chain_not_supported(options: { readonly chain: string }): string;
    /**
     ...
     * `{{- time}} (UTC+8)`
     */
    history_duration(options: { readonly time: string }): string;
    /**
     * `Best Wishes!`
     */
    best_wishes(): string;
     ...
     * `From: @{{name}}`
     */
    ['from'](options: { readonly name: string }): string;
    /**
    ...
    {{payload}}`
      */
    share_message_official_account(
        options: Readonly<{
            sender: string;
            network: string;
            account: string;
    ...
    {{payload}}`
      */
    share_unclaimed_message_official_account(
        options: Readonly<{
            sender: string;
            network: string;
            account: string;
    ...
    {{payload}}`
      */
    share_unclaimed_message_not_twitter(
        options: Readonly<{
            sender: string;
            network: string;
            payload: string;
     ...
     */
    claim_nft_successful(options: { readonly name: string }): string;
    /**
     * `Lucky Drop`
     */
    lucky_drop(): string;
     ...
     * `You got 1 {{name}}`
     */
    got_nft(options: { readonly name: string }): string;
    /**
     * `History`
     */
    history(): string;
    ...
    /**
      ...
      */
    repost(options: { readonly context: 'lens' | 'twitter' | 'farcaster' }): string;
    /**
     * `Mirror`
     */
    repost$lens(): string;
     ...
     */
    infinite_unlock_tips(options: { readonly token: string }): string;
    /**
     * `Requirements`
     */
    requirements(): string;
    ...
    Claim on Farcaster: {{- link }}`
      */
    share_on_firefly$farcaster_claimed(
        options: Readonly<{
            sender: string;
            link: string;
        }>,
    ...
    Claim on Twitter: {{- link }}`
      */
    share_on_firefly$twitter_claimed(
        options: Readonly<{
            sender: string;
            link: string;
        }>,
    ...
    /**
      ...
      */
    account_promote(options: { readonly context: 'default' | 'twitter' | 'facebook' }): string;
    /**
    ...
    const { t } = useTranslation('com.maskbook.red_packet');
...
export const RedPacketTrans: {
     ...
     */
    nft_shift_select_tip: ComponentType<
        TypedTransProps<
            {
     ...
     */
    nft_non_existed_tip: ComponentType<
        TypedTransProps<
            Readonly<{}>,
            {
     ...
     * `<span>{{count}}</span> NFT`
     */
    nft_select_amount_one: ComponentType<
        TypedTransProps<
            {
     ...
     */
    nft_select_amount_other: ComponentType<
        TypedTransProps<
            {
     ...
     */
    history_claimed_firefly: ComponentType<
        TypedTransProps<
            Readonly<{
                claimedShares: string;
                shares: string;
     ...
     */
    history_nft_claimed: ComponentType<
        TypedTransProps<
            Readonly<{
                claimedShares: string;
                shares: string;
     ...
     */
    follow_somebody_on_somewhere: ComponentType<
        TypedTransProps<
            Readonly<{
                handles: string;
                platform: string;
     ...
     */
    no_sent_history_data: ComponentType<
        TypedTransProps<
            Readonly<{}>,
            {
                div: JSX.Element;
    ...
    /**
      ...
      */
    nft_select_amount: ComponentType<
        TypedTransProps<
            {
                readonly count: string | number | bigint;
            },
