...
import { type StrategyPayload,
    StrategyType,
    PlatformType} from '@/providers/types/RedPacket.js'

import { useRedPacketTrans } from '@/plugins/RedPacket/locales/index.js';
import {
    REQUIREMENT_ICON_MAP,
    REQUIREMENT_TITLE_MAP,
} from '@/plugins/RedPacket/SiteAdaptor/ClaimRequirementsDialog.jsx';
import { type RedPacketSettings } from '@/plugins/RedPacket/SiteAdaptor/hooks/useCreateCallback.jsx';
import { useCreateFTRedpacketCallback } from '@/plugins/RedPacket/SiteAdaptor/hooks/useCreateFTRedpacketCallback.js';
import { type FireflyContext, type FireflyRedpacketSettings, RequirementType } from '@/plugins/RedPacket/types.js';
