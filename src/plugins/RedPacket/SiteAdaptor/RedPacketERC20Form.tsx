...
} from '@/plugins/RedPacket/constants.js';
import { useRedPacketTrans } from '@/plugins/RedPacket/locales/index.js';
import { type RedPacketSettings, useCreateParams } from '@/plugins/RedPacket/SiteAdaptor/hooks/useCreateCallback.jsx';
import { useDefaultCreateGas } from '@/plugins/RedPacket/SiteAdaptor/hooks/useDefaultCreateGas.js';
