...
import { EnhanceableSite, getEnhanceableSiteType, PluginID } from '@masknet/shared-base';
import { memo } from 'react';
import { Trans } from 'react-i18next';

import { base } from '@/plugins/RedPacket/base.js';
import { openDialog } from '@/plugins/RedPacket/SiteAdaptor/emitter.js';
import {
    RedPacketMetadataReader,
    RedPacketNftMetadataReader,
    renderWithRedPacketMetadata,
    renderWithRedPacketNftMetadata,
} from '@/plugins/RedPacket/SiteAdaptor/helpers.js';
import { RedPacketInjection } from '@/plugins/RedPacket/SiteAdaptor/RedPacketInjection.jsx';
import { RedPacketInPost } from '@/plugins/RedPacket/SiteAdaptor/RedPacketInPost.jsx';
import { RedPacketNftInPost } from '@/plugins/RedPacket/SiteAdaptor/RedPacketNftInPost.jsx';
