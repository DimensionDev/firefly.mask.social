...
import { RedPacketMetaKey, RedPacketNftMetaKey } from '@/plugins/RedPacket/constants.js';
import schema from '@/plugins/RedPacket/schema.json';
import schemaNtf from '@/plugins/RedPacket/schema-nft.json';
