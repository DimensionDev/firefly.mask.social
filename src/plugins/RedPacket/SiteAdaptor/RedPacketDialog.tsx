...
import { ClaimRequirementsDialog } from '@/plugins/RedPacket/SiteAdaptor/ClaimRequirementsDialog.jsx';
import { ClaimRequirementsRuleDialog } from '@/plugins/RedPacket/SiteAdaptor/ClaimRequirementsRuleDialog.jsx';
import { FireflyRedpacketConfirmDialog } from '@/plugins/RedPacket/SiteAdaptor/FireflyRedpacketConfirmDialog.jsx';
import { FireflyRedPacketHistoryDetails } from '@/plugins/RedPacket/SiteAdaptor/FireflyRedPacketHistoryDetails.jsx';
import { FireflyRedPacketPast } from '@/plugins/RedPacket/SiteAdaptor/FireflyRedPacketPast.jsx';
import type { RedPacketSettings } from '@/plugins/RedPacket/SiteAdaptor/hooks/useCreateCallback.jsx';
import { openComposition } from '@/plugins/RedPacket/SiteAdaptor/openComposition.js';
import { RedPacketERC20Form } from '@/plugins/RedPacket/SiteAdaptor/RedPacketERC20Form.jsx';
import { RedPacketERC721Form } from '@/plugins/RedPacket/SiteAdaptor/RedPacketERC721Form.jsx';
import { CompositionTypeContext } from '@/plugins/RedPacket/SiteAdaptor/RedPacketInjection.jsx';
import { reduceUselessPayloadInfo } from '@/plugins/RedPacket/SiteAdaptor/utils/reduceUselessPayloadInfo.js';
import type { FireflyContext, FireflyRedpacketSettings } from '@/plugins/RedPacket/types.js';
