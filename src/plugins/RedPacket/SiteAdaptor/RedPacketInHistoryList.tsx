...
import { useRedpacketToken } from '@/plugins/RedPacket/SiteAdaptor/hooks/useRedpacketToken.js';
import { RedPacketActionButton } from '@/plugins/RedPacket/SiteAdaptor/RedPacketActionButton.jsx';
import { RedPacketStatus, type RedPacketSentInfo } from '@/providers/types/RedPacket.js';
                ...
                <Box className={classes.box}>
                    <Box className={classes.content}>
                        <section className={classes.section}>
                            ...
                            {redpacket_status && redpacket_status !== RedPacketStatus.View ? (
