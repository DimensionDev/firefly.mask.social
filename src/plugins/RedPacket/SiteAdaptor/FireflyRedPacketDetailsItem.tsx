...
import { PlatformType,
    ...
    StrategyType,} from '@/providers/types/RedPacket.js';

import { RedPacketTrans, useRedPacketTrans } from '@/plugins/RedPacket/locales/index.js';
import { FireflyRedPacketAccountItem } from '@/plugins/RedPacket/SiteAdaptor/FireflyRedPacketAccountItem.jsx';
import { RedPacketActionButton } from '@/plugins/RedPacket/SiteAdaptor/RedPacketActionButton.jsx';
...
const platformIconMap = {
    [PlatformType.twitter]: <Icons.TwitterXRound variant="light" size={18} />,
    [PlatformType.lens]: <Icons.Lens size={18} />,
    [PlatformType.farcaster]: <Icons.Farcaster size={18} />,
};
...
export const FireflyRedPacketDetailsItem = memo(function FireflyRedPacketDetailsItem(props: Props) {
    ...
    const postReactionStrategy = claim_strategy?.find((x) => x.type === StrategyType.postReaction);
    return (
                ...
                <Box className={classes.box}>
                    <Box className={classes.content}>
                        <section className={classes.section}>
                                        ...
                                        <div className={classes.icons}>
                                            {post_on
                                                ?.sort((a, b) => {
                                                    ...
                                                    if (a.platform === PlatformType.lens) return 1;
                                                    if (b.platform === PlatformType.lens) return -1;
                                                    return 0;
                                                })
                                                .map((x) => (
                                                    <PlatformButton
                            ...
                            {redpacket_status &&
                            redpacket_status !== RedPacketStatus.View &&
                            redpacket_status !== RedPacketStatus.Send ? (
