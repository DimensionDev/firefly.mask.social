...
import { RED_PACKET_MAX_SHARES } from '@/plugins/RedPacket/constants.js';
import { useRedPacketTrans } from '@/plugins/RedPacket/locales/index.js';
import { useCreateNFTRedpacketGas } from '@/plugins/RedPacket/SiteAdaptor/hooks/useCreateNftRedpacketGas.js';
import { RedpacketMessagePanel } from '@/plugins/RedPacket/SiteAdaptor/RedpacketMessagePanel.jsx';
import { RedpacketNftConfirmDialog } from '@/plugins/RedPacket/SiteAdaptor/RedpacketNftConfirmDialog.jsx';
import {
    type OrderedERC721Token,
    SelectNftTokenDialog,
} from '@/plugins/RedPacket/SiteAdaptor/SelectNftTokenDialog.jsx';
import { NFTSelectOption } from '@/plugins/RedPacket/types.js';
