...
import { type ChainId, signMessage } from '@masknet/web3-shared-evm';
...
import { useClaimNftRedpacketCallback } from '@/plugins/RedPacket/SiteAdaptor/hooks/useClaimNftRedpacketCallback.js';
import { useNftRedPacketContract } from '@/plugins/RedPacket/SiteAdaptor/hooks/useNftRedPacketContract.js';
